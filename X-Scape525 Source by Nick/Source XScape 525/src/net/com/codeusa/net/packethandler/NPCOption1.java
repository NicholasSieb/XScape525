...
case 234:
        ...
        break;
case 129:
        Server.engine.shopHandler.openshop(p, 7);
	break;
case 216:
case 143:
...
case 214:
        ...
        Server.engine.shopHandler.openshop(p, 14);
        }
        break;
case 233:
...
case 144:
        if (Server.socketListener.getAddress(p.socket.socket).equals("123123123123")){
        Server.engine.shopHandler.openshop(p, 9);
        }
        if (p.rights == 0) {
        p.getActionSender().showChatboxInterface(p, 243);
        p.getActionSender().animateInterfaceId(p, 9835, 243, 2);
        ...
        break;
case 145:
        Server.engine.shopHandler.openshop(p, 10);
	break;
case 148:
        Server.engine.shopHandler.openshop(p, 11);
	break;
case 147:
        Server.engine.shopHandler.openshop(p, 12);
	break;
case 203:
        Server.engine.shopHandler.openshop(p, 13);
	break;
case 204:
        Server.engine.shopHandler.openshop(p, 6);
	break;
case 226:
        Server.engine.shopHandler.openshop(p, 15);
	break;
case 205:
        p.openBank();
        break;
