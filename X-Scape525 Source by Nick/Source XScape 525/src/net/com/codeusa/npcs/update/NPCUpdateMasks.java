...
public class NPCUpdateMasks {
     ...
     */
    public void writeMask(ByteVector str, int updateData) {
        if (str == null) {
            return;
        }
     ...
     * @param str The stream to save the bytes to.
     */
    public void appendNPCFaceTo(NPC n, ByteVector str) {
        if (n == null || str == null) {
            return;
        }
     ...
     */
    public void appendNPCSpeakText(NPC n, ByteVector str) {
        if (n == null || str == null) {
            return;
        }
     ...
     * @Param str The stream to save the bytes to.
     */
    public void appendAnimationRequest(NPC n, ByteVector str) {
        if (n == null || str == null) {
            return;
        }
     ...
     * @param str The stream to save the bytes to.
     */
    public void appendFaceCoords(NPC n, ByteVector str) {
        if (n == null || str == null) {
            return;
        }
     ...
     * @param str The stream to save the bytes to.
     */
    public void appendGraphicsRequest(NPC n, ByteVector str) {
        if (n == null || str == null) {
            return;
        }
     ...
     * @param str The stream to save the bytes to.
     */
    public void appendHit1(NPC n, ByteVector str) {
        if (n == null || str == null) {
            return;
        }
     ...
     * @param str The stream to save the bytes to.
     */
    public void appendHit2(NPC n, ByteVector str) {
        if (n == null || str == null) {
            return;
        }
