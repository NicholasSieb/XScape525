...
public class NPCUpdate extends NPCUpdateMasks {
     ...
     */
    public void appendNPCUpdateMasks(NPC n, ByteVector str) {
        if (str == null || n == null) {
            return;
        }
        if (!n.updateReq) {
     ...
     */
    public void addNewNPC(Player p, NPC npc, ByteVector str) {
