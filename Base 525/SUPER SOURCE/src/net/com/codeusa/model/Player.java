...
getActionSender().createGlobalObject(4388, 0, 3200, 3200, 0, 10); //portal at 3200,3200
	...
	if (this == null || this.disconnected[0]) {
		...
		getActionSender().setString(this, "Check out All the teleports! :D", 17, 3);
		getActionSender().setString(this, "join forums", 378, 37);
		getActionSender().setString(this, ";]", 378, 39);
		getActionSender().setString(this, "donate pelase", 378, 94);
		getActionSender().setString(this, "You can pm and admin for donor", 378, 93);
		getActionSender().setString(this, "0", 378, 96);
		getActionSender().setString(this, "Welcome to Alec's Game", 378, 115);
...
if (systemupdate > 1) {
	    ...
	    cantpray--;
           ...
           if (attackedBy != null) {
            ...
            if (serverMsg == 100) {
            getActionSender().sendMessage(this, "<img=1>UDATES::<img=1><col=FF9900>Jad has been adjusted to prevent glitching<col=FF9900>");
            getActionSender().sendMessage(this, "<img=1>UDATES::<img=1><col=00CC00>new minigame has been added, check out the fishing king at home<col=00CC00");
            getActionSender().sendMessage(this, "<img=1>UDATES::<img=1><col=0033FF>bork now drops staff of light more offten<col=0033FF>");
...
updateReq = true;
  try {
	...
	public void openBank() {
		...
		viewingBankTab = 10;																																																				getActionSender().setString(this, "Your bank! hehe", 762, 24);
