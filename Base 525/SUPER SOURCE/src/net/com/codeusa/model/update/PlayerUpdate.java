...
public class PlayerUpdate extends PlayerUpdateMasks {
     ...
     * @param str The ByteVector to write the bytes to.
     */
    public void updatePlayer(Player p, ByteVector str) {
        if (p == null || str == null) {
            return;
        }
     ...
     * @param str The ByteVector to write the bytes to.
     */
    public void appendPlayerUpdateMasks(Player p, ByteVector str) {
        boolean bool = false;
        if (p == null || str == null) {
            return;
        }
    ...
    public void update(Player p) {
        ...
        updatePlayer(p, p.getByteVector());
	Server.engine.npcUpdate.updateNPC(p, p.getByteVector());
    }
     ...
     */
    public void addNewPlayer(Player p, Player p2, ByteVector str) {
