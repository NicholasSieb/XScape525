...
public class SwitchItems2 implements Packet {
    ...
    public void handlePacket(Player p, int packetId, int packetSize) {
		...
		if((fromInterface == 50003968 || toInterface == 50003968) && fromInterface != toInterface) {
			...
			//	p.getActionSender().sendMessage(p, "You can't drag a item from your inventory to your bank!");
			//} else {
			//	p.getActionSender().sendMessage(p, "You can't drag a item from your bank to your inventory!");
			//}
			return;
		}
        switch (interfaceId) {
