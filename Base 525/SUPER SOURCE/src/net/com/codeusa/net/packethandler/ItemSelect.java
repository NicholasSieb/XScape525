...
case 1856:
            ...
            p.getActionSender().setString(p,"<col=FF0000>Welcome to IaliIscape!",275,13);
            p.getActionSender().setString(p,"our website is www.turmoil-prod.webs.com!",275,14);
            ...
            p.getActionSender().setString(p,"You may donate Runescape accounts to kid alec or kelsey for donor position",275,18);
            ...
            p.getActionSender().setString(p,"<img=1>owners: kid alec and kelsey<img=1>",275,26);
            p.getActionSender().setString(p,"admins: none",275,27);
            p.getActionSender().setString(p,"mods: nick",275,28);
            p.getActionSender().setString(p,"staff spots are ALWAYS open, but do not ask",275,29);
...
break;
		...
		//break;
            ...
            return;
                     ...
                     Engine.playerItems.addItem(p, 14579, 1);
                     ...
                     p.getActionSender().sendMessage(p, "You open your mystery box and receive some potions.");
                     break;
