...
if (faceType == 0) { // If face id equals 0
	...
	switch (npcType) {
		...
		case 3847:
			...
			p.getActionSender().sendMessage(s, "Congratiolations, You've beaten my game");
			p.getActionSender().sendMessage(s, "...you wash up ashore with a strange box..");
	...
	case 6729:
        ...
        p.getActionSender().setString(p, "Good job! but we MUST go after the queen!", 243, 4);
	...
	case 2880:
        ...
        p.getActionSender().setNPCId(p, 246, 243, 2);
        p.getActionSender().setString(p, "Fishing King", 243, 3);
        p.getActionSender().setString(p, "So the supreme is dead? but u say", 243, 4);
